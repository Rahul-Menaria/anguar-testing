...
/* harmony export */ });
/* harmony import */ var _getBlobFromURL__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getBlobFromURL */ 5847);
/* harmony import */ var _clonePseudoElements__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./clonePseudoElements */ 1056);
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util */ 4839);
...
/* harmony export */ });
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ 4839);
...
/* harmony export */ });
/* harmony import */ var _getBlobFromURL__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getBlobFromURL */ 5847);
/* harmony import */ var _embedResources__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./embedResources */ 8727);
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util */ 4839);
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
/* harmony export */ });
/* harmony import */ var _getBlobFromURL__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./getBlobFromURL */ 5847);
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./util */ 4839);
...
/* harmony export */ });
/* harmony import */ var _cloneNode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cloneNode */ 9816);
/* harmony import */ var _embedImages__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./embedImages */ 1);
/* harmony import */ var _embedWebFonts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./embedWebFonts */ 9103);
/* harmony import */ var _createSvgDataURL__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createSvgDataURL */ 5825);
/* harmony import */ var _applyStyleWithOptions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./applyStyleWithOptions */ 6729);
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./util */ 4839);
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
/* harmony import */ var _F_Work_Deepak_fronthandtesting_node_modules_ngtools_webpack_src_loaders_direct_resource_js_editimage_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./editimage.page.html */ 4887);
/* harmony import */ var _editimage_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./editimage.page.scss */ 6611);
...
EditimagePage = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.Component)({
        ...
        template: _F_Work_Deepak_fronthandtesting_node_modules_ngtools_webpack_src_loaders_direct_resource_js_editimage_page_html__WEBPACK_IMPORTED_MODULE_0__.default,
        styles: [_editimage_page_scss__WEBPACK_IMPORTED_MODULE_1__]
    })
], EditimagePage);
...
/***/ 4887:
/*!**************************************************************************************************************************!*\
  !*** ./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./src/app/pages/users/editimage/editimage.page.html ***!
  \**************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
module.exports = "ion-back-button {\n  display: block;\n}\n\n#choose-file {\n  width: -webkit-fit-content;\n  width: -moz-fit-content;\n  width: fit-content;\n}\n\n.content {\n  position: relative;\n  display: grid;\n  align-items: center;\n  justify-content: center;\n}\n\n.content ion-card {\n  z-index: 1;\n  display: grid;\n  grid-template-columns: repeat(1, 1fr);\n}\n\n.content ion-card ion-card-content {\n  position: relative;\n  display: grid;\n  align-items: center;\n  justify-items: center;\n}\n\n.content ion-card ion-card-content #logo {\n  position: absolute;\n  top: 4%;\n  left: 7%;\n  border-radius: 50%;\n  width: 55px;\n  height: 60px;\n}\n\n.content ion-card ion-card-content #background-img {\n  background-size: cover;\n  background-attachment: fixed;\n}\n\n.content ion-card ion-card-content #businessName {\n  position: absolute;\n  top: 3.5%;\n  left: 24%;\n  display: flex;\n  align-items: center;\n  text-align: center;\n  justify-content: center;\n  word-break: break-all;\n  z-index: 5;\n  height: 65px;\n  width: 210px;\n}\n\n.content ion-card ion-card-content #businessName h1 {\n  color: #1d1c1c;\n  text-overflow: ellipsis;\n  font-size: 1.6rem;\n  font-weight: 700;\n}\n\n.content ion-card ion-card-content h4 {\n  position: absolute;\n  z-index: 5;\n  color: #1d1c1c;\n  top: 13.8%;\n  left: 48%;\n  font-weight: 700;\n  font-size: 0.9rem;\n}\n\n.content ion-button {\n  margin: 0 1rem;\n  width: -webkit-fit-content;\n  width: -moz-fit-content;\n  width: fit-content;\n  justify-self: center;\n}\n\n.content ion-button ion-icon {\n  margin-right: 1rem;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */";
